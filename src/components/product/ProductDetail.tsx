...
export function ProductDetailPage({ product, relatedProducts }: ProductDetailPageProps) {
  ...
  const initialSize = params.get('size') || undefined
  const defaultVariant = product.variants.find((v:any)=> (initialColor ? v.color===initialColor : true) && (initialSize ? v.size===initialSize : true)) || product.variants[0]
              ...
              <div className="space-y-6">
                ...
                {product.variants.some((v: any) => v.size) && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {([...new Set(product.variants.map((v: any) => v.size))] as string[]).map((size) => {
                        ...
                        return (
                          <button
                            key={size}
                            onClick={() => {
                              const variant = sizeVariants.find((v: any) => v.stock > 0) || sizeVariants[0]
                ...
                {product.variants.some((v: any) => v.color) && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {([...new Set(product.variants.map((v: any) => v.color))] as string[]).map((color) => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-12 h-12 rounded-full border-4 hover:scale-110 transition-transform ${
                              isSelected ? 'border-gold-500' : 'border-gray-300'
            ...
            <div className="border-t border-gray-200 pt-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-black">Shipping Across Kenya</p>
                    <p className="text-sm text-gray-600">Country wide Access </p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
